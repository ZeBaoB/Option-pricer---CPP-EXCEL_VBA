...
int main() {
    ...
    std::cout << "----- Constant risk free rate ----- Spot = 42, Strike = 45, Maturity = 6 mois, r = 0.05, sigma = 25% -----------------------------------------------------\n\n";
    ...
    std::cout << "-------------------------- Call ------------------------------------------------------------------------------------------------------------------------------------\n";
    std::cout << "-------------------------- Spot = 42, Strike = 45, Maturity = 6 mois, r =environ 0.045 (positif), sigma = 25% ------------------------------------------------------\n\n";
    call = true;
    ...
    std::cout << "-------------------------- Call -------------------------------------------------------------------------------------------------------------------------------------\n";
    std::cout << "-------------------------- Spot = 42, Strike = 45, Maturity = 6 mois, r =environ -0.045 (negatif), sigma = 25% ------------------------------------------------------\n\n";
    call = true;
    //---------------------------------------------------------------------------------------------------------------
    // Début de la mesure du temps
    start = std::chrono::high_resolution_clock::now();
